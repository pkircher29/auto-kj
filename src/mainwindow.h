...
private:
    ...
    DlgStreamingServices *dlgStreamingServices{nullptr};
    ...
    MediaBackend m_mediaBackendPreview{this, "PRV", MediaBackend::BackgroundMusic};
    ...
    AutoKJServerAPI m_songbookApi;
    QComboBox *m_comboBoxVenue{nullptr};
    QComboBox *m_comboBoxDj{nullptr};
...
private slots:
    ...
    void onVenuesChanged(const OkjsVenues &venues);
    void onVenueSelected(int index);
    void onDjSelected(int index);
    void updateDjList();
    ...
    void previewSong(const QString &path);
