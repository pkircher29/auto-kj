...
class TableModelQueueSongs : public QAbstractTableModel
{
    Q_OBJECT
public:
    enum {COL_ID=0,COL_DBSONGID,COL_SINGER1,COL_SINGER2,COL_SINGER3,COL_SINGER4,COL_ARTIST,COL_TITLE,COL_SONGID,COL_KEY,COL_DURATION,COL_PATH};
    ...
    int add(int songId, const QStringList &cosingers = {});
    void insert(int songId, int position, const QStringList &cosingers = {});
    // Returns true if the singer identified by singerId is at or over the queue limit
    bool isQueueFull(int singerId) const;
...
public slots:
    void songAddSlot(int songId, int singerId, int keyChg = 0, const QStringList &cosingers = {});
