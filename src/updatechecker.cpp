...
void UpdateChecker::downloadInstaller()
{
    ...
    {
        if (OS == "Win64")
            url = "https://storage.googleapis.com/Auto-KJ-windows-builds-master/Auto-KJ-" + availVersion + "-64bit-setup.exe";
        if (OS == "Win32")
            url = "https://storage.googleapis.com/Auto-KJ-windows-builds-master/Auto-KJ-" + availVersion + "-32bit-setup.exe";
        if (OS == "MacOS")
